...
# %% auto 0
__all__ = ['BaseContextChoice', 'ContextChoiceLinear', 'ContextChoiceConstant']
...
class BaseContextChoice(nn.Module):
    ...
    """
    def __init__(self, attention_heads: int, embedding_dim: int) -> None:
        """
        Initializer.
...
class ContextChoiceLinear(BaseContextChoice):
    def __init__(self, attention_heads: int, embedding_dim: int) -> None:
        super(ContextChoiceLinear, self).__init__(attention_heads, embedding_dim)
...
class ContextChoiceConstant(BaseContextChoice):
    def __init__(self, attention_heads: int, embedding_dim: int) -> None:
        super().__init__(attention_heads, embedding_dim)
    ...
    def forward(self, embeddings_local: torch.FloatTensor, embeddings_global: torch.FloatTensor) -> torch.FloatTensor:
        ...
        scores_local = F.sigmoid(self.bias.view((1, 1, self.attention_heads, 1)))
